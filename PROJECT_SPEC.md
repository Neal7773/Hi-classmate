...
13. New mobile game screens should prioritize instant scanning: make the active question visually dominant, keep answer controls to roughly half the viewport instead of filling unused height, and compress results around one prominent score/percentage plus short keyword chips. Avoid long result paragraphs or footer disclaimers inside the interactive result card; keep necessary context in the supporting page copy.
