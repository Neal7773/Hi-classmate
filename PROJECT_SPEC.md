...
13. New mobile game screens should prioritize instant scanning: keep the main game-card footprint stable across play states, make the active question large and heavy, and keep the combined answer area around one-quarter to one-third of the viewport instead of stretching the controls. Compress results around one prominent score/percentage plus short keyword chips. Avoid long result paragraphs or footer disclaimers inside the interactive result card; keep necessary context in the supporting page copy.
